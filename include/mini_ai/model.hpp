...
#include <vector>
namespace mini_ai {
// DOCUMENTACIÓN_AQUÍ: Config describe vocabulario, contexto y tamaños internos del
// modelo. Model encadena embeddings, atención causal, MLP residual y salida softmax.
struct Config {
